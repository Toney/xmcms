...
<div class="grid_12 bar">
    <div class="ui-buttonset mgl_10">
        <input type="button" class="ui-button ui-widget ui-state-default" value="网站语言" onclick="window.location.href='index.php?r=admin/language/index'" />
        <input type="button" class="ui-button ui-widget ui-state-active" value="后台语言"  />
    </div>
</div>
