<div class="grid_12 bar">
    <span class="item"><i class="icon-home"></i>后台首页</span><span><i class="icon-angle-double-right"></i>信息管理</span><span><i class="icon-angle-double-right"></i>内容管理</span><span><i class="icon-angle-double-right"></i>
        <?php echo $id==0?"新建下载":"编辑下载" ?>
    </span>
</div>

<div class="grid_12 container">
    <div class="container_in">
        <form name="form_edit" id="form_edit" action="index.php?r=admin/download/edit" method="post">
            ...
            <table class="form">
                <tr>
                    ...
                    <td><input type="text" name="title" class=" validate[required] control " value="<?php echo $download==null?"":$download['title'] ?>"   /></td>
                </tr>
                <tr>
                    <td class="col1">
                ...
                <tr>
                    ...
                    <td><textarea name="description" style="width: 90%;height: 300px;"><?php echo $download==null?"":$download['description'] ?></textarea></td>
                </tr>
                <tr>
                    <td class="col1">
                        <label>排序</label>
                    </td>
                    <td><input type="text" name="seq" class=" validate[custom[integer]] control " value="<?php echo $download==null?"":$download['seq'] ?>"  /></td>
                </tr>
                <tr>
                    <td class="col1">
                        <label>标签</label><span class="red">*</span>
                    </td>
                    <td><input type="text" name="tags" class=" validate[required] control " value="<?php echo $download==null?"":$download['tags'] ?>"   /></td>
                </tr>
                <tr>
                    <td class="col1">
                        <label>推荐</label>
                    ...
                    <td><select name="recommend" class="control">
                            <?php
                            if($download!=null&&$download['recommend']==1){
                                ?>
                ...
                <tr>
                    ...
                    <td><select name="top" class="control">
                            <?php
                            if($download!=null&&$download['top']==1){
                                ?>
                                <option value="0">否</option>
                                <option value="1" selected="selected">是</option>
                            <?php
...
<script>
    ...
    $(function(){
        ...
        editor = initEdit("description",'download')
    });
    function save(){
