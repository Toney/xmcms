            ...
            <form name="form_edit" id="form_edit" action="edit" method="post" >
                ...
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="small validate[required] " name="title" value="<?php echo $image['title']; ?>" />&nbsp;&nbsp;<span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="label">图片</td>
                        <td><input type="text" class="small " name="image" value="<?php echo $image['image']; ?>" />
                            &nbsp;&nbsp;<button class="btn" id="imageselect">选择图片</button>&nbsp;&nbsp;<button class="btn"  onclick="viewImg()">预览</button>&nbsp;&nbsp;<span class="red">*</span>
                            <div class="hid"><a id="prviewimg" href="<?php echo $image['image']?>"><img id="imgprviewimg" src=""/></a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                                ...
                                ?>
                                <input type="text" class="small validate[required,custom[integer]] " name="orderby" value="<?php echo $image['orderby'] ?>"  />
                            <?php
                            }
                            ?>
                        </td>
...
<script>
    ...
    var module_setting = {
        ...
        async: {
            enable: true,
            url: "../module/treeByType?type=image&moduleid=<?php echo $image['module_id']; ?>"
        },
        check:{
            chkStyle: "checkbox",
            enable:true,
