<div data-role="page">
    ...
    <div role="main" class="ui-content">
            ...
            <div class="ui-block-a">
                <ul data-role="listview" data-inset="true" data-divider-theme="a">
                    ...
                    foreach($list as $article){
                        ?>
                        <li><a href="index.php?r=wap/product/view&article_id=<?php echo $article['article_id']; ?>">
                                <img src="<?php echo $article['product']['image']; ?>" style="width: 100%;height: 100%;">
        ...
        if($pagenow>1){
            ?>
            <a href="index.php?r=wap/article/index&module_id=<?php echo $module['module_id'] ?>&page=<?php echo $pagenow-1; ?>" class="ui-btn">上一页</a>
            <?php
        }
        ...
        if($pages->pageCount>$pagenow){
            ?>
            <a href="index.php?r=wap/article/index&module_id=<?php echo $module['module_id'] ?>&page=<?php echo $pagenow+1; ?>" class="ui-btn">下一页</a>
            <?php
        }
        ?>
