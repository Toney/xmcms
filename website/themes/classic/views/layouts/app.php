        ...
        <div class="grid_12 " style="line-height:50px;">
            ...
            <span class="fr">
                ...
                foreach($LANGALL as $lang){
                    $mark = $lang['mark'];
                    ?>
                    &nbsp;<a href="javascript:changeLang('<?php echo $mark; ?>')"><img src='<?php echo $lang['flag']; ?>'/></a>
                <?php
                }
                ?>
            </span>
...
/*                    }*/
                    ?>
                    <?php echo $user['username']; ?>&nbsp;&nbsp;<a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=member/shoppingcart"><i class="icon-shopping-cart"></i></a>&nbsp;&nbsp;<a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=member/index"><i class="icon-user"></i></a>
