...
<div class="container_12 mgb">
    <div class="grid_12" >
        <div class="box " style="line-height: 30px;padding-left:10px;border:1px solid #ff6666;">
            <i class="icon-volume-up" style="color:#ff6666;margin-right: 10px;"></i>
            <?php
            if($notice!=null){
                ?>
...
<div class="container_12 "  >
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-book"></i>&nbsp;&nbsp;橱柜知识
