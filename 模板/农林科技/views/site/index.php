...
<div class="container_12 "  >
    <div class="grid_6 mgb bg_white" style="min-height: 370px;" >
        <div class="p20"   >
            <?php
            ...
            <div class="itemlist plr">
                <ul>
                    ...
                    foreach($articles as $article){
                        ?>
                        <li><a href="<?php echo $this->getUrl($article['infotype'],"view",Array(id=>$article['article_id'])); ?>"><?php echo csubstr($article['title'],0,30,'utf-8',true); ?></a><span class="fr"><?php echo $article['createtime']; ?></span></li>
                    <?php
                    }
                    ?>
                </ul>
