<div class="container_12 mgb">
    <div class="grid_12" style="">
        <div class="banner">
            <ul>
                <li><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/img/banner_1.gif"/></li>
                <li><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/img/banner_2.gif"/></li>
                <li><img src="<?php echo Yii::app()->theme->baseUrl; ?>/css/img/banner_3.gif"/></li>
            </ul>
        </div>
        <style>
            .banner {
...
<div class="container_12 "  >
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-flag"></i>&nbsp;&nbsp;主营业务
            </div>
            <div class="p20">
                <?php
                $i=0;
...
<!--新闻资讯相关-->
<div class="container_12 mgb">
    <div class="grid_4 bg_white"   style="min-height: 370px;" >
        <div class="box ">
    ...
    <div class="grid_4 bg_white" style="min-height: 370px;" >
        <div class="box ">
            <div class="head ui-widget-header "><i class="icon-user"></i>&nbsp;&nbsp;新闻资讯</div>
            <div class="itemlist plr">
                <ul>
                    <?php
