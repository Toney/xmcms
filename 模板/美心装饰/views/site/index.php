...
<div class="container_12 mgb">
    <div class="grid_4" >
        <div class="box ">
            <div class="head ui-widget-header "><i class="icon-flag"></i>&nbsp;&nbsp;风水指南
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>38)); ?>"><i class="icon-double-angle-right"></i></a></span></span>
            </div>
            <div class="itemlist plr">
                <ul>
                    <?php
                    foreach($fengshui as $article){
                        ?>
    ...
    <div class="grid_4" >
        <div class="box ">
            <div class="head ui-widget-header "><i class="icon-pencil"></i>&nbsp;&nbsp;设计指南
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>37)); ?>"><i class="icon-double-angle-right"></i></a></span></span>
            </div>
            <div class="itemlist plr">
                <ul>
                    <?php
                    foreach($sheji as $article){
                        ?>
                        <li><a href="<?php echo $this->getUrl($article['infotype'],"view",Array(id=>$article['article_id'])); ?>"><?php echo csubstr($article['title'],0,15,'utf-8',true); ?></a><span class="fr"><?php echo $article['createtime']; ?></span></li>
                    <?php
                    }
    ...
    <div class="grid_4" >
        <div class="box ">
            <div class="head ui-widget-header "><i class="icon-user"></i>&nbsp;&nbsp;招贤纳士
                <span class="fr"><a href="<?php echo $this->getUrl('job',"index",Array(id=>32)); ?>"><i class="icon-double-angle-right"></i></a></span></span>
            </div>
            <div class="itemlist plr">
                <ul>
                    <?php
                    foreach($jobs as $article){
                        ?>
                        <li><a href="<?php echo $this->getUrl($article['infotype'],"view",Array(id=>$article['article_id'])); ?>"><?php echo csubstr($article['title'],0,15,'utf-8',true); ?></a><span class="fr"><?php echo $article['createtime']; ?></span></li>
                    <?php
                    }
