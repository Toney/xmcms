...
<div class="container_12 "  >
    <div class="grid_4 mgb bg_white" style="min-height: 370px;" >
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-home"></i>&nbsp;&nbsp;关于公司
            </div>
            <div class="p20"   >
                <?php
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-flag"></i>&nbsp;&nbsp;新闻动态
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-signal"></i>&nbsp;&nbsp;业界资讯
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>56)); ?>"><i class="icon-double-angle-right"></i></a></span>
            </div>
