...
<div class="container_12 mgb">
    <div class="grid_12" >
        <div class="box " style="line-height: 30px;padding-left:10px;border:1px solid #333333;">
            <i class="icon-volume-up" style="color:#333333;margin-right: 10px;"></i>
            <?php
            if($notice!=null){
                ?>
                <a  href="<?php echo $this->getUrl('article',"view",Array(id=>$notice[0]['article_id'])); ?>"  ><?php echo  $notice[0]['title']; ?></a>
                <?php
            }
            ?>
        </div>
...
<div class="container_12 "  >
    <div class="grid_4 mgb bg_white" style="min-height: 370px;" >
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-thumbs-up-alt"></i> &nbsp;&nbsp;独家优势
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-bullhorn"></i>&nbsp;&nbsp;活动资讯
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>61)); ?>"><i class="icon-double-angle-right"></i></a></span>
            </div>

            <div class="itemlist plr">
                <ul>
                    <?php
                    foreach($zixuns as $article){
                        ?>
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-book"></i>&nbsp;&nbsp;新娘课堂
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>65)); ?>"><i class="icon-double-angle-right"></i></a></span>
            </div>
