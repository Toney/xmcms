...
<div class="container_12 "  >
    <div class="grid_4 mgb bg_white" style="min-height: 370px;" >
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-home"></i>&nbsp;&nbsp;关于我们
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-flag"></i>&nbsp;&nbsp;公司新闻
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>54)); ?>"><i class="icon-double-angle-right"></i></a></span>
            </div>
    ...
    <div class="grid_4 mgb bg_white"  style="min-height: 370px;">
        <div class="box " >
            <div class="head ui-widget-header "><i class="icon-signal"></i>&nbsp;&nbsp;行业资讯
                <span class="fr"><a href="<?php echo $this->getUrl('article',"index",Array(id=>55)); ?>"><i class="icon-double-angle-right"></i></a></span>
            </div>
